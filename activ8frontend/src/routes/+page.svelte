  ...
  <div class="grid grid-cols-2 min-h-screen z-10">
    <div class="items-center self-center">
      ...
      {:else}
        ...
        <button class="flex mr-12 mt-12 mx-12 text-white text-center font-semibold" on:click={handleLogin}>
          <span class="bg-black w-28 h-10 rounded-full hover:opacity-90">Get Started</span>
        </button>
      {/if}
    </div>
